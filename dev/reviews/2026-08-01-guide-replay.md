...
[proxmox-setup.md](../../docs/guides/proxmox-setup.md) assumes. Everything else matches the
[hardware spec](../specs/2026-07-31-hardware-specs-design.md).
...
[coolify-setup.md](../../docs/guides/coolify-setup.md) opens by restating it.
...
**Finding:** [coolify-setup.md](../../docs/guides/coolify-setup.md) steps 1 and 2 should merge
...
**Finding:** [traefik-setup.md:126](../../docs/guides/traefik-setup.md) says to expect
...
[grafana-setup.md, step 4](../../docs/guides/grafana-setup.md#4-verify-the-platform):
...
[authentik-setup.md](../../docs/guides/authentik-setup.md) does for `akadmin`. And step 5
...
[step 4](../../docs/guides/grafana-setup.md#4-verify-the-platform) says to "log in as `admin`
...
**Finding:** [uptime-kuma-setup.md, step 3](../../docs/guides/uptime-kuma-setup.md#3-start-the-stack)
