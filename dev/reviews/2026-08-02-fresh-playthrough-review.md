...
[proxmox-setup.md](../../docs/guides/proxmox-setup.md) → … →
[home-assistant-setup.md](../../docs/guides/home-assistant-setup.md) — with every compose
...
- [proxmox-setup.md:314](../../docs/guides/proxmox-setup.md) — "This is where Coolify's app
  volumes, databases and image layers live — the part that actually grows"
- [proxmox-setup.md:706](../../docs/guides/proxmox-setup.md) — "app volumes, databases, build
  cache and image layers go on the `data` mirror, because that is the part
  that grows without asking"

But no step in [apps-vm-setup.md](../../docs/guides/apps-vm-setup.md),
[coolify-setup.md](../../docs/guides/coolify-setup.md) or `scripts/init-coolify.sh` moves
...
[coolify-setup.md](../../docs/guides/coolify-setup.md)'s own layout table half-knows this:
...
[apps-vm-setup.md](../../docs/guides/apps-vm-setup.md) (after the `/data` mount, before the
...
| Document | Claim |
|---|---|
| [proxmox-setup.md:333](../../docs/guides/proxmox-setup.md) | "Until it is, everything on the apps VM's data disk is **unbacked**" |
| [apps-vm-setup.md:194](../../docs/guides/apps-vm-setup.md) | "treat everything under `/data` as **unbacked** and deploy accordingly" |
| [coolify-setup.md:224](../../docs/guides/coolify-setup.md) | "`/data/coolify/` is **the thing to back up**. Nothing under it is reproducible from this repo" |
...
**Status: Confirmed.** [proxmox-setup.md Part 5](../../docs/guides/proxmox-setup.md#part-5--create-the-vms)
...
[home-assistant-setup.md step 2](../../docs/guides/home-assistant-setup.md#2-create-an-empty-vm),
...
**Status: Confirmed.** [home-assistant-setup.md step 1](../../docs/guides/home-assistant-setup.md#1-download-the-image-on-the-proxmox-host):
...
**Status: Confirmed.** [uptime-kuma-monitors.md](../../docs/reference/uptime-kuma-monitors.md#optional-group-them-on-the-dashboard)
...
**Status: Confirmed.** [forgejo-setup.md step 7](../../docs/guides/forgejo-setup.md#7-add-the-pipeline-to-your-repo)
...
[Step 8](../../docs/guides/forgejo-setup.md#8-run-a-build-and-verify-the-image) then verifies
with:
...
[forgejo-setup.md step 4](../../docs/guides/forgejo-setup.md#4-register-the-runner). Nothing
...
([authentik-setup.md step 1](../../docs/guides/authentik-setup.md#1-run-the-init-script))
...
- CLAUDE.md names "HA's **pre-DNS onboarding URL**" as one of the remaining
  ...
  [home-assistant-setup.md step 5](../../docs/guides/home-assistant-setup.md#5-start-it-then-name-it)
...
- **grafana-setup.md claims step 6 is "the only step in any guide that runs on
  the Proxmox host"** ([grafana-setup.md:213](../../docs/guides/grafana-setup.md)).
...
- **home-assistant-setup.md step 8 chains `cd ~/home-lab/infra/monitoring &&
  ...
  ([home-assistant-setup.md:187](../../docs/guides/home-assistant-setup.md)) — the same
...
- **grafana-setup.md's Alloy `fmt` check mounts the config via
  `/opt/stacks/monitoring/…`** ([grafana-setup.md:778](../../docs/guides/grafana-setup.md)) —
