...
| **TrueNAS / Unraid as the base OS** | Rejected. These are storage appliances with VM support bolted on; Proxmox is a hypervisor with first-class ZFS. The four-pool layout is already built on the stronger foundation, and the storage design in the [hardware spec](../specs/2026-07-31-hardware-specs-design.md) needs nothing TrueNAS offers. |
...
domain it watches. [uptime-kuma-monitors.md](../../docs/reference/uptime-kuma-monitors.md)'s
...
[coolify-setup.md](../../docs/guides/coolify-setup.md)'s troubleshooting ("if both proxies
...
The [hardware spec](../specs/2026-07-31-hardware-specs-design.md)
...
[proxmox-setup.md](../../docs/guides/proxmox-setup.md) by hand.
