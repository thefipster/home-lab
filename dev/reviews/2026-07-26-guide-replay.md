...
> | 3 — Missing Dockge guide | New [dockge-setup.md](../../docs/guides/dockge-setup.md), stating explicitly that the init script starts the stack |
> | 4 — Forgejo Part 0 duplication | Collapsed to a one-line prerequisite plus the Forgejo-specific init step |
> | 5 — Clock skew after rollback | `init-host.sh` sets chrony `makestep 1 -1` as its first step; documented in [proxmox-setup.md Part 8](../../docs/guides/proxmox-setup.md#part-8--snapshot-before-you-build), cross-referenced from Traefik and Forgejo troubleshooting |
...
> | 10 — Monitoring guide as migration | Merged into [grafana-setup.md](../../docs/guides/grafana-setup.md); `monitoring-setup.md` deleted; from-scratch-only policy recorded in CLAUDE.md |
...
[traefik-setup.md:104–115](../../docs/guides/traefik-setup.md) says the curl check needs
...
**Status: Confirmed, with nuance.** [authentik-setup.md:104–110](../../docs/guides/authentik-setup.md)
...
([sso-applications.md](../../docs/reference/sso-applications.md#forward-auth-dockge--traefik-dashboard)),
...
**Status: Confirmed.** [forgejo-setup.md:43–126](../../docs/guides/forgejo-setup.md) restates
...
- [`docs/proxmox-setup.md` Part 8](../../docs/guides/proxmox-setup.md#part-8--snapshot-before-you-build)
...
**Status: Confirmed — good catch.** [forgejo-setup.md:195–200](../../docs/guides/forgejo-setup.md)
...
**Status: Confirmed.** [forgejo-setup.md:155–158](../../docs/guides/forgejo-setup.md) buries
...
([sso-applications.md](../../docs/reference/sso-applications.md#forgejo-oidc)), procedure in
...
container in [grafana-setup.md troubleshooting](../../docs/guides/grafana-setup.md#troubleshooting),
...
With special mentions of the two registries — **[dns-records.md](../../docs/reference/dns-records.md)**
at the DNS step (every later step assumes the records exist) and
**[sso-applications.md](../../docs/reference/sso-applications.md)** at the Authentik step (every
...
- The runner registration command in
  [forgejo-setup.md](../../docs/guides/forgejo-setup.md#4-register-the-runner) still passes a
