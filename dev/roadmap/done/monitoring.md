...
1. **✅ Landed** — see [docs/guides/grafana-setup.md](../../../docs/guides/grafana-setup.md).
...
2. **✅ Landed** — see [docs/guides/grafana-setup.md](../../../docs/guides/grafana-setup.md).
   **Logs** — Alloy `discovery.docker` + `loki.source.docker`: every container
   ...
   would.
3. **✅ Landed** — see [docs/guides/grafana-setup.md](../../../docs/guides/grafana-setup.md).
...
4. **✅ Landed** — see [docs/guides/grafana-setup.md](../../../docs/guides/grafana-setup.md).
...
5. **✅ Landed** — see [docs/guides/grafana-setup.md](../../../docs/guides/grafana-setup.md).
...
- **RAM: resolved.** The infra VM was resized for this stack before phase 1
  ...
  [proxmox-setup.md](../../../docs/guides/proxmox-setup.md#why-these-sizes)) is sized with these
