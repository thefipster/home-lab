...
([proxmox-setup.md Part 9](../../docs/guides/proxmox-setup.md#part-9--notice-when-a-mirror-degrades))
...
[proxmox-setup.md](../../docs/guides/proxmox-setup.md#part-3--post-install-housekeeping)
