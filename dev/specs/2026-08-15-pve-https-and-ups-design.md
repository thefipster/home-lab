...
the same call [grafana-setup.md step 6](../../docs/guides/grafana-setup.md#6-add-the-proxmox-host)
and [proxmox-setup.md Part 9](../../docs/guides/proxmox-setup.md#part-9--notice-when-a-mirror-degrades)
...
([sso-applications.md](../../docs/reference/sso-applications.md)) one level down: the thing you
...
clock. It gets a row in [timetable.md](../../docs/reference/timetable.md) beside Traefik's.
...
[sso-applications.md](../../docs/reference/sso-applications.md) records it as a deliberate
...
treatment [timetable.md](../../docs/reference/timetable.md) gives Kuma's heartbeat sizing.
...
([uptime-kuma-monitors.md](../../docs/reference/uptime-kuma-monitors.md)). The monitor is
...
[backup-restore-drill.md](../../docs/drills/backup-restore-drill.md), and repeated when the
battery is replaced.
...
- **`Site Power`'s deadman is weak by construction**, as stated above. Closing it
  ...
  [uptime-kuma-monitors.md](../../docs/reference/uptime-kuma-monitors.md) already records for
  Kuma itself.
