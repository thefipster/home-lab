...
[sso-applications.md](../reference/sso-applications.md#forward-auth-dockge-traefik-dashboard--homepage).
...
One monitor, from [uptime-kuma-monitors.md](../reference/uptime-kuma-monitors.md#start-page--homepage):
...
[uptime-kuma-monitors.md](../reference/uptime-kuma-monitors.md) at the same time — the two
...
is [The `homelab` status page](../reference/uptime-kuma-monitors.md#the-homelab-status-page).
...
[uptime-kuma-monitors.md](../reference/uptime-kuma-monitors.md); change them together.
