...
Its row is in
[uptime-kuma-monitors.md](../reference/uptime-kuma-monitors.md#backup--infra-vm): **Add New
...
> [backup-restore-drill.md](../drills/backup-restore-drill.md). It covers what to change
...
[sso-applications.md](../reference/sso-applications.md), which is what that registry exists
for.
