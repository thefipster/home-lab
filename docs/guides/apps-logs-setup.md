...
VM** ([dns-records.md](../reference/dns-records.md)) — the `*.thefipster.de` wildcard answers
with *this* machine:
...
[uptime-kuma-monitors.md](../reference/uptime-kuma-monitors.md#deliberately-not-monitored).
