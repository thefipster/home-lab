...
5. **Management network** — the one place in the whole lab where you type
   ...
   - **IP (CIDR):** the `pve ip` from [dns-records.md](../reference/dns-records.md), with your
...
wildcard, on a different clock ([timetable.md](../reference/timetable.md)).
...
[sso-applications.md](../reference/sso-applications.md#the-proxmox-web-ui-deliberately-not-joined)
...
its row is in [uptime-kuma-monitors.md](../reference/uptime-kuma-monitors.md) — and copy its
push URL.
...
different — [dns-records.md](../reference/dns-records.md#no-aaaa-records-anywhere) has the
...
[uptime-kuma-monitors.md](../reference/uptime-kuma-monitors.md#power--proxmox-host) — and
copy its push URL.
...
[uptime-kuma-monitors.md](../reference/uptime-kuma-monitors.md#power--proxmox-host) precisely
