...
([dns-records.md](../reference/dns-records.md)) and should already exist from the DNS step:
...
([uptime-kuma-monitors.md](../reference/uptime-kuma-monitors.md#vault--vaultwarden)).
...
([uptime-kuma-monitors.md](../reference/uptime-kuma-monitors.md#vault--vaultwarden)) plus the
