...
> [sso-applications.md](../reference/sso-applications.md#uptime-kuma-deliberately-not-joined).
...
[uptime-kuma-monitors.md](../reference/uptime-kuma-monitors.md)** — grouped by stack, with the
...
[uptime-kuma-monitors.md](../reference/uptime-kuma-monitors.md#hypervisor-storage--proxmox-host)
...
- [ ] Every monitor in [uptime-kuma-monitors.md](../reference/uptime-kuma-monitors.md) exists
