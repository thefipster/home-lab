...
**Prerequisite:** [backup-setup.md](../guides/backup-setup.md) complete — the repository
...
Each drill gets a dated finding in `dev/reviews/`, the same way the guide
...
[backup-setup.md](../guides/backup-setup.md#last-resort-the-raw-pgdata), and it operates
