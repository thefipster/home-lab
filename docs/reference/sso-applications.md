...
Every **infra-VM** service behind [Authentik](../guides/authentik-setup.md), with the
...
|---------|--------|------------------|-----------|
| Traefik dashboard | forward-auth | Authentik only | [authentik-setup.md, step 3](../guides/authentik-setup.md#3-gate-the-traefik-dashboard-forward-auth) |
| Dockge | forward-auth | Authentik only | [dockge-setup.md, step 1](../guides/dockge-setup.md#1-create-the-dockge-application-in-authentik) |
| Homepage | forward-auth | Authentik only | [homepage-setup.md, step 2](../guides/homepage-setup.md#2-create-the-authentik-provider-and-application) |
| Forgejo | OIDC | Authentik + Forgejo admin UI + `infra/forgejo/compose.yaml` | [forgejo-setup.md, step 5](../guides/forgejo-setup.md#5-join-sso-oidc-via-authentik) |
...
[authentik-setup.md, step 4](../guides/authentik-setup.md#4-add-a-user-and-a-group).
...
[grafana-setup.md, step 5](../guides/grafana-setup.md#5-join-sso-oidc-via-authentik).
...
([vaultwarden-setup.md](../guides/vaultwarden-setup.md)) rather than after it.
...
([backup-setup.md](../guides/backup-setup.md)). It has no browser UI to gate and speaks no
...
[authentik-setup.md, step 5](../guides/authentik-setup.md#5-control-who-reaches-what)
