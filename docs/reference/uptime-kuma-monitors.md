...
[uptime-kuma-setup.md](../guides/uptime-kuma-setup.md).
...
([uptime-kuma-setup.md, step 5](../guides/uptime-kuma-setup.md#5-add-the-monitors)) and only
...
[proxmox-setup.md Part 9](../guides/proxmox-setup.md#part-9--notice-when-a-mirror-degrades),
...
Kuma's half of the split ([uptime-kuma-setup.md](../guides/uptime-kuma-setup.md)) — putting
...
([grafana-setup.md](../guides/grafana-setup.md#what-diskalmostfull-sees-under-zfs)). A
...
> ([proxmox-setup.md Part 10](../guides/proxmox-setup.md#7-put-it-on-a-timer)). Sixty
...
[proxmox-setup.md Part 10](../guides/proxmox-setup.md#part-10--survive-a-power-cut).
...
rule exists ([grafana-setup.md](../guides/grafana-setup.md#dashboards-and-alerts)).
...
The job and its timer live on the infra VM — [backup-setup.md](../guides/backup-setup.md).
...
[backup-setup.md Part 2](../guides/backup-setup.md#part-2--the-kuma-push-monitor).
...
[backup-setup.md, Troubleshooting](../guides/backup-setup.md#troubleshooting).
...
([grafana-setup.md](../guides/grafana-setup.md#6-add-the-proxmox-host)).
