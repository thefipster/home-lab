...
#      See docs/guides/proxmox-setup.md, Part 7. First, because step 2 uses apt.
...
echo
echo "Done. Verify (see docs/guides/infra-vm-setup.md or docs/guides/apps-vm-setup.md):"
